...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="single-blog">
            ...
            <ul class="post-meta">
                <li><i class="fa fa-pencil-square-o"></i><strong> <?=\Yii::t('books', 'Posted By')?>:</strong> John</li>
            ...
            <a href="<?= Url::to(['books/view', 'slug' => $book->slug, 'id' => $book->id]) ?>" class="btn btn-primary">
